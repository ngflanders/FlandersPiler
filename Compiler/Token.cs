...
namespace Compiler
{
    ...
    class Token
    {
        ...
        *********************************************************************************/
        ...
        public Token(TOKENTYPE inTokType, string inName, int inLine)
        {
            tokType = inTokType;
            lexName = inName;
            lineNumber = inLine;
        ...
        {
            //return String.Format("{0,4}   {1,-20}{2}", lineNumber, "Test", lexName);
            return String.Format("{0,4}:Token {1,-3}: {2,-23} {3}",
                                lineNumber,(int)tokType,tokType,lexName );
        } // ToString
